...
test_that("test normal function of file import of type 1",{
  ...
  exp_type_1 <- cleanDT_(exp_type_1, "experimental", 1, logfilename)[["dat"]]
  expect_known_hash(exp_type_1, "ab5287b084")

  exp_type_1 <- fread(paste0(prefix, "testdata/exp_type_1.csv"))
  exp_type_1 <- cleanDT_(exp_type_1, "experimental", 1, logfilename)
...
test_that("test normal function of file import of type 2",{
  ...
  exp_type_2 <- cleanDT_(exp_type_2, "experimental", 2, logfilename)[["dat"]]
  ...
  cal_type_2 <- cleanDT_(cal_type_2, "calibration", 2, logfilename)[["dat"]]
...
test_that("wrong type",{
  # type 1 data
  cal_type_1 <- fread(paste0(prefix, "testdata/cal_type_1.csv"))
  expect_null(cleanDT_(cal_type_1, "calibration", 3, logfilename))
  expect_null(cleanDT_(cal_type_1, "calibration", "a", logfilename))

  exp_type_1 <- fread(paste0(prefix, "testdata/exp_type_1.csv"))
  expect_null(cleanDT_(exp_type_1, "experimental", 65, logfilename))
  expect_null(cleanDT_(exp_type_1, "experimental", "tre", logfilename))

  # type 2 data
  cal_type_2 <- fread(paste0(prefix, "testdata/cal_type_2.csv"))
  expect_null(cleanDT_(cal_type_2, "calibration", 3, logfilename))
  expect_null(cleanDT_(cal_type_2, "calibration", "a", logfilename))

  exp_type_2 <- fread(paste0(prefix, "testdata/exp_type_2.csv"))
  expect_null(cleanDT_(exp_type_2, "experimental", 65, logfilename))
  expect_null(cleanDT_(exp_type_2, "experimental", "tre", logfilename))
})
...
test_that("wrong first column in calibration data type 1",{
  ...
  expect_null(cleanDT_(cal_type_1, "calibration", 1, logfilename))
...
test_that("heterogenous cpg-sites per locus in type 2 data", {
  ...
  expect_null(cleanDT_(cal_type_2, "calibration", 2, logfilename))
