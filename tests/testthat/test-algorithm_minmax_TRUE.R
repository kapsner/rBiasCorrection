...
test_that(
  ...
  code = {
    ...
    expect_known_hash(rv$final_results, "16fca713ba") # 920658389f
    ...
    expect_known_hash(rv$fileimport_cal_corrected, "d082d296f8") # 913f716d0c
    ...
    expect_known_hash(rv$fileimport_cal_corrected_h, "5e110ecf0d") # fc5617597f
    ...
    expect_known_hash(rv$fileimport_cal_corrected_c, "d0447e2521") # a99f550089
...
test_that(
  ...
  code = {
    ...
    expect_type(rv$final_results, "list")
    expect_s3_class(rv$final_results, "data.table")
    expect_known_hash(rv$final_results, "47c0df77e1") # eea1c59606
    expect_type(rv$substitutions, "list")
    expect_s3_class(rv$substitutions, "data.table")
    ...
    expect_type(rv$fileimport_cal_corrected, "list")
    expect_s3_class(rv$fileimport_cal_corrected, "data.table")
    expect_known_hash(rv$fileimport_cal_corrected, "341a01cdf9") # 5b8a8f6887
  })
