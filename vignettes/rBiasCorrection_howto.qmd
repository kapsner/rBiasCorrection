...
data.table::fwrite(temp_file, file.path(tempdir(), "experimental_data.csv"))
cols <- c("true_methylation", "CpG#1")
temp_file <- rBiasCorrection::example.data_calibration$dat[
  , cols, with = FALSE
]
data.table::fwrite(temp_file, file.path(tempdir(), "calibration_data.csv"))
```
